...
const Header = () => {
    ...
    const themeToggle = (set:string) => setTheme(set);
    const userMenuHandle = () => setUserMenu(!userMenu);
            ...
            <div className="flex grow flex-col items-center justify-between lg:flex-row lg:px-6">
                ...
                <div className="w-full items-center justify-between gap-4 px-5 py-4 shadow-theme-md lg:flex lg:justify-end lg:px-0 lg:shadow-none hidden">
                    <div className="flex items-center gap-2 2xsm:gap-3">
                        {/* Dark Mode Toggler */}
                        <button 
                            onClick={()=>themeToggle(currentTheme=="dark"?"light":"dark")} 
                            className={`hover:text-dark-900 relative flex h-11 w-11 items-center justify-center rounded-full border border-gray-200 bg-white transition-colors hover:bg-gray-100 hover:text-gray-700 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-400 dark:hover:bg-gray-800 dark:hover:text-white`}
                        >
                            <ThemeIcon theme={currentTheme as ThemeIconType} />
                        </button>
                    </div>

                    <div className="relative" >
                        <button title="User Menu" className="flex items-center text-gray-700 dark:text-gray-400 dark:border-gray-800 dark:hover:bg-gray-800 rounded-xl border px-2" 
                            onClick={userMenuHandle}
                            ref={buttonRef}
                        >
                            <span className="h-11 w-11 overflow-hidden flex items-center justify-between">
                                <svg className="fill-gray-500 group-hover:fill-gray-700 dark:fill-gray-400 dark:group-hover:fill-gray-300" width="30" height="30" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        { userMenu &&
                            <div 
                                className={`absolute right-0 mt-[17px] flex w-[260px] flex-col rounded-2xl border border-gray-200 bg-white dark:bg-slate-800 p-3 shadow-theme-lg dark:border-gray-800 dark:bg-gray-dark z-9999`}
                                ref={menuRef}
                            >
                                <ul className="flex flex-col gap-1 border-b border-gray-200 pb-3 pt-4 dark:border-gray-600">
                                    <li>
                                        <Link href={`/admin/user/edit/${user?.id}`} className="group flex items-center gap-3 rounded-lg px-3 py-2 text-theme-sm font-medium text-gray-700 hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300">
                                    ...
                                    <li>
                                        <button title="Account settings" className="w-full group flex items-center gap-3 rounded-lg px-3 py-2 text-theme-sm font-medium text-gray-700 hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300">
                                            <svg className="fill-gray-500 group-hover:fill-gray-700 dark:fill-gray-400 dark:group-hover:fill-gray-300" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <li>
                                        <button title="Support" className="w-full group flex items-center gap-3 rounded-lg px-3 py-2 text-theme-sm font-medium text-gray-700 hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300">
                                            <svg className="fill-gray-500 group-hover:fill-gray-700 dark:fill-gray-400 dark:group-hover:fill-gray-300" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
