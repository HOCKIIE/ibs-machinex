...
const Page = ({ params }:{ params: { id: number } }) => 
{
    ...
    useEffect(() => {
        if (items.length > 0) {
            ...
            form.reset({
                id: items[0].id ?? 0,
                image_th: items[0].image_th ?? null,
                image_en: items[0].image_en ?? null,
                image_ja: items[0].image_ja ?? null,
                current_th: items[0].current_th ?? null,
                current_en: items[0].current_en ?? null,
                current_ja: items[0].current_ja ?? null,
