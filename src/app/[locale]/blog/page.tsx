                                ...
                                <div className="grid gap-5 overflow-hidden bg-white rounded-2xl">
                                    <Link href={'/blog/' + firstBlog.pathName} className="group">
                                        ...
                                        <div className="p-4">
                                            ...
                                            <p className="text-gray-700">{firstBlog[`description_${locale}`]}</p>
                                        </div>
                                    </Link>
                                </div>
                            </div>
                                    ...
                                    <Link href={'/blog/' + item.pathName} className="group block">
                                        <div className="grid overflow-hidden ">
                                            ...
                                            <div className="p-4">
                                                ...
                                                <H3 className="text-[20px] text-xl text-black font-bold group-hover:text-red-600 line-clamp-2" custom={true}>{item[`title_${locale}`]}</H3>
